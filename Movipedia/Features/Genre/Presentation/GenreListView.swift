...
struct GenreListView: View {
    @StateObject private var viewModel = GenreInjection.provideGenreViewModel()
    ...
    var body: some View {
        Group {
            if viewModel.isLoading && viewModel.genres.isEmpty {
                ...
                ErrorView(message: error) { viewModel.loadGenres() }
        ...
        .onAppear { viewModel.loadGenresIfNeeded() }
    }
